...
degenes.table<-read.table('line7u_vs_i.degenes.tophits.nucl.txt', stringsAsFactors=F, sep="\t", header=T)
annots<-select(org.Gg.eg.db, keys=degenes.table$geneID, columns=c("SYMBOL","ENTREZID"), keytype="ENSEMBL")
