...
degenes.table<-read.table('line7u_vs_i.cufflinks.degenes.fdr.05.tophits.hsa',
...
write.table(kegg.sig, 'line7u_vs_i.cufflinks.degenes.hsa.kegg.txt',
            sep='\t', row.names=F, quote=F)

write.table(uniq.annotated.degenes[!is.na(uniq.annotated.degenes$PATH),],
            'line7u_vs_i.cufflinks.degenes.hsa.kegg.id.txt',
